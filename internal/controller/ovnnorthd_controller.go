...
import (
	...
	"github.com/openstack-k8s-operators/ovn-operator/internal/ovnnorthd"
...
//+kubebuilder:rbac:groups=apps,resources=deployments,verbs=get;list;patch;update;delete;watch;
